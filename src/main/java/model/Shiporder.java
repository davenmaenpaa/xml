...
public class Shiporder {
     ...
     * 
     * <p>
     * This accessor method returns a reference parseTo the live list,
     * not a snapshot. Therefore any modification you make parseTo the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the item property.
     * 10
     * <p>
     * For example, parseTo add a new item, do as follows:
     * <pre>
     *    getItem().add(newItem);
     * </pre>
     * 
