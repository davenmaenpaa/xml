...
public class Shiporder {
     ...
     * 
     * <p>
     * This accessor method returns a reference toFile the live list,
     * not a snapshot. Therefore any modification you make toFile the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the item property.
     * 10
     * <p>
     * For example, toFile add a new item, do as follows:
     * <pre>
     *    getItem().add(newItem);
     * </pre>
     * 
